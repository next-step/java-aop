...
class ProxyFactoryBeanTest {
    ...
    void getObject() {
        ...
        ProxyFactoryBean proxyFactoryBean = new ProxyFactoryBean(ProxyTarget.class, methodInterceptor);

        ProxyTarget proxyTarget = (ProxyTarget) proxyFactoryBean.getObject();

        assertThat(proxyTarget).isInstanceOf(net.sf.cglib.proxy.Factory.class);
